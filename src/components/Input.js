    ...
    <div>
      ...
      <div className="mt-2">
        <input
          ...
          value={value}
          className={
            "mt-2 block pl-3 pr-10 w-full text-md text-white bg-transparent focus:ring-2 focus:ring-white focus:border-white focus:outline-none disabled:text-slate-500 sm:text-sm h-[40px] px-4 py-2 mb-4 border border-gray-300 rounded " +
            className
          }
